...
| **URL** | **HTTP Verb** | **Action** | **Description**         | **Routing Code**     |
| ------- | ------------- | ---------- | ----------------------- | -------------------- |
| /       | GET           | index      | get all cookbooks       | api/cookbooks/       |
| /       | GET           | show       | get a cookbook by title | api/cookbooks/:title |
| /       | PUT           | update     | update a cookbook       | api/cookbooks/:id    |
| /       | DELETE        | destroy    | destroy a cookbook      | api/cookbooks/:title |
